                    ...
                    if (task.isSuccessful()) {
                        ...
                        for (QueryDocumentSnapshot document : task.getResult()) {
                            ...
                            db.collection("viñedos").document(idVinedos).get().addOnSuccessListener(doc -> {
                                ...
                                Toast.makeText(misEventos.this, "Error al cargar datos del viñedo", Toast.LENGTH_SHORT).show();
                                updateUI();
                            });
                        }
                        ...
                        Toast.makeText(misEventos.this, "Error al obtener favoritos", Toast.LENGTH_SHORT).show();
                        updateUI();
                    }
                });
    }
